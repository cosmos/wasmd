...
func TestStoreCodeProposal(t *testing.T) {
	...
	msgContent, err := govv1beta2.NewLegacyContent(src, myActorAddress)
	require.NoError(t, err)
...
func TestExecuteProposal(t *testing.T) {
	...
	myActorAddress := govKeeper.GetGovernanceAccount(ctx).GetAddress().String()
	msgContent, err := govv1beta2.NewLegacyContent(&badSrc, myActorAddress)
...
func TestAdminProposals(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			// when stored
			myActorAddress := govKeeper.GetGovernanceAccount(ctx).GetAddress().String()
			msgContent, err := govv1beta2.NewLegacyContent(spec.srcProposal, myActorAddress)
...
func TestUpdateParamsProposal(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			// when stored
			myActorAddress := govKeeper.GetGovernanceAccount(ctx).GetAddress().String()
			msgContent, err := govv1beta2.NewLegacyContent(&proposal, myActorAddress)
